    ...
    switch (indexPath.section) {
        case ZBWelcome: {
            ...
            case ZBWelcomeLink: {
                ...
                cell.textLabel.text = NSLocalizedString(@"Welcome to 2e's Zebra!", @"");
    ...
    switch (row) {
        case ZBMastodon: {
            NSArray *mastodonURLs = @[
                ...
                [NSURL URLWithString:@"mastodon://profile/@pwnd2e@mastodon.social"],
        ...
        case ZBTwitter:
            [self openURL:[NSURL URLWithString:@"https://twitter.com/pwnd2e"]];
            break;
        case ZBDiscord:
